...
<body>
            ...
            <div class="about-row row">
                ...
                <div class="detail-col col-md-8">
                    ...
                    <p>
                        ...
                        the majority is have suffered alteration in that some form by
                        injected humour or randomised that words which don't look even
                        slightly believable. If you are going a to use a passage of Lorem
                        Ipsum you need to be sure there isn't anything embarrassing. There
                        are is many variations of passages available.
                    </p>
                    <div class="row">
            ...
            <div class="services-row row">
                <div class="col-md-4 seric-div">
                    <div class="service-card">
                        ...
                        <p>
                            Lorem ipsum dolor sit aconsect dipisicing elit, sed do eiusmod
                            to incididunt uabore etdolore magna aliqua.
                        </p>
                    </div>
                </div>
                <div class="col-md-4 seric-div">
    ...
    <div id="skills" class="skills container-fluid">
        <div class="row">
            <div class="col-md-12 skii-div tech-skill">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul>
                            <li>
                                <label for="">UI/UX Designer</label><i class="val">95%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">JavaScript</label><i class="val">75%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">HTML5</label><i class="val">55%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">PHP / MYSQL</label><i class="val">65%</i>
                                <div class="progress">
                    ...
                    <div class="col-md-6">
                        <ul>
                            <li>
                                <label for="">Photoshop</label><i class="val">90%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">Illustrator</label><i class="val">80%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">AngularJS</label><i class="val">60%</i>
                                <div class="progress">
                            ...
                            <li>
                                <label for="">PHP</label><i class="val">70%</i>
                                <div class="progress">
    ...
    <section id="cntact_us" class="contact-us-single mb-5">
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Nai Wan Na</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                Developed by
                <a href="https://www.facebook.com/shinehtetaung99" target="_blank">Shine Htet Aung</a>
            </div>
        </div>
    </footer>
    <!-- End  Footer -->
